...
class HRM1Controller extends Controller
{
    ...
    public function apar_save(Request $request)
    {
        #validation
        $this->validate($request, [
            "pdf" => "mimes:doc,pdf,docx,xls,xlsx",
            'tittle' => "required"
        ]);
    ...
    public function dpc_save(Request $request)
    {
        ...
        return redirect(url('add-dpc1'))->with(['success' => 'Data uploaded Successfully']);
    }
    ...
    public function dpc_delete($id)
    {
        ...
        return redirect(url('add-dpc1'))->with(['error' => 'Data deleted successfully']);
    }
