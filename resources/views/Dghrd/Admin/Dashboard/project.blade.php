...
<x-layout>
    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            ...
            <h3 class="page-title">Ongoing/Upcoming Infrastructure Projects</h3>
            <!-- row -->
            <div class="card mb-4">
...
@if ($value)
    <form method="post" action="{{ url('add-project') . '/' . $value->id ?? '' }}" enctype="multipart/form-data">
@else
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Ongoing/Upcoming Infrastructure Projects Table</h4>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->date ?? '' }}</td>
                                            <td>
                                                <a href="{{ url('project-delete') . '/' . $data->id ?? '' }}"><button
                                                        type="button" class="btn btn-danger">
                                                        <i class="ti-trash" style="font-size: 18px;"></i>
                                                    </button></a>
                                                <a href="{{ url('add-project') . '/' . $data->id ?? '' }}"><button
